...
inline std::vector<Entity> hardcoded_Entitys = {
	Entity(
		"spartan1", // Entity name
		's', // view
	...
	Entity(					/* This player Entity is always processed last, as it is the last Entity in the Entity list. */
		"player",			// Entity name
		'p',				// view
